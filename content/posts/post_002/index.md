...
![A list with indices 0 to 71 can be divided into containers based on a three-dimensional shape (in this case cube).](images/01_cubes.jpg "A list with indices 0 to 71 can be divided into containers based on a three-dimensional shape (in this case cube).")
