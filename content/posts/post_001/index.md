...
image = "/images/listImages/01_b_to_t.avif"
imageBig = ""
...
![Adding an extra path to each node makes ternary tree out of binary tree.](images/01_b_to_t.avif "Adding an extra path to each node makes ternary tree out of binary tree.")
...
![Finding node indices at extremities for each level of the ternary tree.](images/02_indices.avif "Finding node indices at extremities for each level of the ternary tree.")
...
![Binary search and level search timings compared, with search items generated randomly.](images/03_compared.avif "Binary search and level search timings compared, with search items generated randomly.")
