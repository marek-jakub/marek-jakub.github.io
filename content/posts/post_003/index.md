...
![Figure 1: A structure of nested lists is created as collisions occur. Here the length of lists decreases by 1 at each inner level.](images/02_structure.png "Figure 1: A structure of nested lists is created as collisions occur. Here the length of lists decreases by 1 at each inner level.")
...
![Figure 2: Item range and lists' length predispose speed and space efficiency.](images/03_speed_space.png "Figure 2: Item range and lists' length predispose speed and space efficiency.")
