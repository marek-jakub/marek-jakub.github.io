...
{% include image.html url="/images/post2022-03-16/03_input.png" description="Figure 1: Line after line of integer couples signifying previous nodes’ children." %}
...
{% include image.html url="/images/post2022-03-16/02_lists.png" description="Figure 2: Even if nested lists provide tree structure approximation and simple implementation, they could be difficult to work with." %}
