...
{% include image.html url="/images/post2021-11-20/01_cubes.jpg" description="A list with indices 0 to 71 can be divided into containers based on a three-dimensional shape (in this case cube)." %}
...
The code is available at https://github.com/marek-jakub/shapedList as well.
